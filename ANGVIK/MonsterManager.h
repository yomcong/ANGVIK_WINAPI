...
#define kongMaxCount 10
#define monkeyMaxCount 8
...
private:
	...
	float spawnKongPosX[kongMaxCount] = { 880.0f, 1475.0f, 1910.0f, 2500.0f, 2970.0f, 3715.0f,4245.0f, 4340.0f, 5430.0f , 6315.0f };
	float spawnKongPosY[kongMaxCount] = { 385.0, 265.0f, 388.0f, 508.0f, 550.0f, 210.0f,605.0f, 840.0f, 300.0f, 280.0f };

	float spawnMonkeyPosX[monkeyMaxCount] = { 500.0f, 850.0f, 1100.0f, 1400.0f, 2200.0f, 2300.0f, 4100.0f, 4200.0f  };
	float spawnMonkeyPosY[monkeyMaxCount] = { 350.0f, 382.0f, 390.0f, 390.0f, 300.0f, 300.0f, 430.0f, 430.0f };
